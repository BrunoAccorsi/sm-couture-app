...
const carouselImages = [
  ...
  require('@/assets/images/about/carousel/sm-couture-item-model-5-man.jpg'),
  ...
  require('@/assets/images/about/carousel/sm-couture-item-model-6.jpg'),
  require('@/assets/images/about/carousel/sm-couture-item-model-7.jpg'),
  require('@/assets/images/about/carousel/sm-couture-item-model-8.jpg'),
  require('@/assets/images/about/carousel/sm-couture-item-22-men.jpg'),
  require('@/assets/images/about/carousel/sm-couture-item-4.jpg'),
  require('@/assets/images/about/carousel/sm-couture-item-23-men.jpg'),
  require('@/assets/images/about/carousel/sm-couture-item-5.jpeg'),
  require('@/assets/images/about/carousel/sm-couture-item-24-men.jpg'),
  require('@/assets/images/about/carousel/sm-couture-item-6.jpeg'),
  require('@/assets/images/about/carousel/sm-couture-item-25-men.jpg'),
